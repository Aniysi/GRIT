...
def generate_commit(llm_client: LLMClient, chat_session: ChatSession) -> CommitMsg:
    ...
    # Generate and return Commit
    return llm_client.generate_commit_message(chat_session)
